...
const cacheName = 'calendarInteractiveGroup6-2021-04-07 14:30:48.500321'; // unique value, generated each deploy
const contentToCache = [
  'index.html',
  'code.js',
  'calendarInteractive.js',
  'style.css',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'calendarInteractiveGroup6'.length) === 'calendarInteractiveGroup6') {
